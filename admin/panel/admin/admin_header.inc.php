...
<html lang="en">
	...
	<head>
		...
		<title>FB Link Oluşturma Paneli</title>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					...
					<ul class="nav navbar-nav">
						...
						<i class="glyphicon glyphicon-home"></i>&nbsp;Reklam Durumu izle</a></li>

						<li <?php echo THIS_PAGE == 'NEWLINK' ? ' class="active"' : ''; ?> ><a href="new_link.php" class="text-center">

						<i class="glyphicon glyphicon-plus"></i>&nbsp;Yeni Reklam Ekle</a></li>
						...
						<i class="glyphicon glyphicon-wrench"></i>&nbsp;Ayarlar</a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<i class="glyphicon glyphicon-log-out"></i>&nbsp;Cikis</a></li>
