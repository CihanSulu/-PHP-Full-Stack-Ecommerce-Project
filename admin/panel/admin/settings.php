...
*  with the European Union.Edit settings
			...
			<div class="panel-body">
                <form action="settings.php" method="post" name="settingsform" class="form-horizontal">
                    ...
                    <div class="form-group<?php echo isset($error_buffer['click_url']) ? ' has-error' : ''; ?>">
                        <label for="url" class="col-lg-3 control-label bold">Sitenin Domaini:</label>
                        <div class="col-lg-9">
                            <input type="url" id="click_url" name="click_url" value="<?php echo stripslashes($ccount_settings['click_url']); ?>" size="50" maxlength="255" class="form-control" placeholder="http://teknolojiburda.com/panel/click.php">
                            <p class="help-block"><?php echo isset($error_buffer['click_url']) ? $error_buffer['click_url'] : 'dosya imi <b>click.php</b> olarak yukle.'; ?></p>
                        </div>
                    </div>
                    <div class="form-group<?php echo isset($error_buffer['db_file']) ? ' has-error' : ''; ?>">
                        <label for="text" class="col-lg-3 control-label bold">Reklam panel database dosya:</label>
                        <div class="col-lg-9">
                            ...
                            <p class="help-block"><?php echo isset($error_buffer['db_file']) ? $error_buffer['db_file'] : 'Db yolu  (defaults to <b>ccount_database.php</b>).'; ?></p>
                        </div>
                    </div>
                    <div class="form-group<?php echo isset($error_buffer['unique_hours']) ? ' has-error' : ''; ?>">
                        <label for="name" class="col-lg-3 control-label bold">ayni ip girisler:</label>
                        <div class="col-lg-9">
                            ...
                            <p class="help-block"><?php echo isset($error_buffer['unique_hours']) ? $error_buffer['unique_hours'] : 'Kac saat tekrar girisleri saymiyayim? Buradaki amac tekrar girisleri yani ayni ip girisleri click olarak sayıp saymamasi 1 saat secerseniz 1 saait icindeki ayni ip tekrarlari yazmaz ama siteye girisler kesilmez (defaults to <b>24</b>).'; ?></p>
                        </div>
                    </div>
                    <div class="form-group<?php echo isset($error_buffer['notation']) ? ' has-error' : ''; ?>">
                        <label for="name" class="col-lg-3 control-label bold">Siteye (24Saat) gunluk bu sayidan fazla click gonderme:</label>
                        <div class="col-lg-9">
							<div class="radio">
								<label>
