				...
				<div class="panel">
					...
					<div class="panel-body">
						...
						<form method="POST" action="index.php" class="form-signin">
							...
							<h2 class="form-signin-heading">Sifre Gir:</h2>

							<input type="password" name="pass" class="input-block-level" value="<?php echo defined('PJ_DEMO') ? $ccount_settings['admin_pass'] : ''; ?>" >

							<label class="checkbox">

								<input type="checkbox" name="remember" value="yes"> Sifremi Aklinda tut

							</label>

							<button class="btn btn-large btn-primary" type="submit">Giris Yap</button>
