...
// fake
$fakeurl = intval( pj_POST('fakeurl', 0) );
			...
			<div class="panel-body">
                <form action="edit_link.php" method="post" name="addlinkform" class="form-horizontal">
                    <div class="form-group<?php echo isset($error_buffer['url']) ? ' has-error' : ''; ?>">
					   ...
					   <div class="form-group<?php echo isset($error_buffer['url']) ? ' has-error' : ''; ?>">
                        <label for="fakeurl" class="col-lg-3 control-label bold">Fake URL:</label>
                        <div class="col-lg-9">
                            <input type="url" id="fakeurl" name="fakeurl" value="<?php echo $ccount_database[$id_old]['F']; ?>" size="50" maxlength="255" class="form-control" placeholder="http://www.example.com">
                            <p class="help-block"><?php echo isset($error_buffer['url']) ? $error_buffer['url'] : 'URL of the link you wish to count clicks on.'; ?></p>
                        </div>
                    </div>
