...
/* so-mobile/template/common/currency.twig */
class __TwigTemplate_d6c47f639a20cbe85deabe25cc5faa3bf905b934a3a9a474ca3756b59106ba72 extends Twig_Template
{
...
";
    ...
    {
        return "so-mobile/template/common/currency.twig";
    }
...
/*         <li>*/
/*           <button class="currency-select btn btn-block" type="button" name="{{ currency.code }}">{{ currency.symbol_left }} {{ currency.title }}</button>*/
/*         </li>*/
/*         {% else %}*/
/*         <li>*/
/*           <button class="currency-select btn btn-block" type="button" name="{{ currency.code }}">{{ currency.symbol_right }} {{ currency.title }}</button>*/
/*         </li>*/
/*         {% endif %}*/
/*         {% endfor %}*/
/*       </ul>*/
