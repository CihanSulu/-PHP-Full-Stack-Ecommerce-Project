...
<head>
  ...
  <title>Yönetici Paneli | İptal Edilen Siparişler</title>
</head>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>İptal Edilen Siparişler <span class="badge badge-danger">Parfüm</span></h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php
                  $query = $conn->query("SELECT * FROM parfum WHERE kayitYontemi = 'iptal' order by id DESC", PDO::FETCH_ASSOC);
                  if ( $query->rowCount() ){
