...
(function ($) {
    ...
    $(function () {
        $(".product-load-more .col-grid-box").slice(0, 60).show();
        $(".loadMore").on('click', function (e) {
            e.preventDefault();
            $(".product-load-more .col-grid-box:hidden").slice(0, 60).slideDown();
            if ($(".product-load-more .col-grid-box:hidden").length === 0) {
                $(this).text('Daha Fazla Ürün Bulunamadı');
            }
        });
    });
    ...
    $(function () {
        $(".infinite-product .product-box").slice(0, 20).show();
