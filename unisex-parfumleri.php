...
<title><?php echo $logo." | Unisex Parfümleri";?></title>
</head>
                ...
                <div class="row">
                    <div class="col-sm-3 collection-filter">
                        ...
                        <div class="theme-card">
                            <h5 class="title-border" style="padding-bottom: 14px;">Öne Çıkan Unisex Parfümleri</h5>
                            <div class="offer-slider slide-1">
                                <div>

                                    <?php 
                                    $query = $conn->query("SELECT * FROM icerik where onecikan='EVET' AND kategori like '%unisex%' and stok>0 order by RAND() DESC limit 3", PDO::FETCH_ASSOC);
                                    if ( $query->rowCount() ){
                        ...
                        <div class="collection-sidebar-banner">
                            <a href="#"><img src="assets/images/sol3.png" class="img-fluid blur-up lazyload"
                                    alt=""></a>
                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="top-banner-wrapper">
                                        ...
                                        <div class="top-banner-content small-section pt-0 pb-0">
                                            <h4 class="text-warning">UNİSEX PARFÜMLERİMİZ</h4>
                                        </div>
                                    </div>
                                    <div class="collection-product-wrapper">
                                        ...
                                        <div class="product-wrapper-grid product-load-more">
                                            <div class="row margin-res">
                                                ...
                                                $query = $conn->query("SELECT * FROM icerik where kategori like '%unisex%' and stok>0 order by id DESC", PDO::FETCH_ASSOC);
                                                if ( $query->rowCount() ){
                                                     foreach( $query as $row ){ ?>
