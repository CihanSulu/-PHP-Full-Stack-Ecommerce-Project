...
<title><?php echo $logo." | Hediye Parfümünü Seç";?></title>
</head>
                ...
                <div class="row">
                    <div class="col-sm-3 collection-filter">
                        ...
                        <div class="theme-card">
                            <h5 class="title-border" style="padding-bottom: 14px;">Öne Çıkan Parfümler</h5>
                            <div class="offer-slider slide-1">
                                <div>

                                    <?php 
                                    $query = $conn->query("SELECT * FROM icerik where onecikan='EVET' and stok>0 order by RAND() DESC limit 3", PDO::FETCH_ASSOC);
                                    if ( $query->rowCount() ){
                                ...
                                <div class="col-sm-12">
                                    <div class="top-banner-wrapper">
                                        ...
                                        <div class="top-banner-content small-section pt-0 pb-0">
                                            <h4 class="text-warning">HEDİYE PARFÜMÜNÜ SEÇ</h4>
                                        </div>
                                    </div>
                                    <div class="collection-product-wrapper">
                                        ...
                                        <div class="product-wrapper-grid product-load-more">
                                            <div class="row margin-res">
                                                ...
                                                $query = $conn->query("SELECT * FROM icerik where stok>0 order by id DESC", PDO::FETCH_ASSOC);
                                                if ( $query->rowCount() ){
                                                     foreach( $query as $row ){ ?>
                                                        ...
                                                        <div class="col-xl-3 col-6 col-grid-box">
                                                            <div class="product-box">
                                                                <div class="img-wrapper">
                                                                    ...
                                                                    <div class="front">
                                                                        <a href="sepet.php?evet=<?php echo $row["id"];?>&normalurun=<?php echo $_GET["id"]; ?>" style="background-size:contain !important;">
                                                                            <img src="https://siparislerimiz.site/dizinler/parfum/img/<?php echo $row["resim"];?>"class="img-fluid " alt="" >
                                                                        </a>
                                                                    </div>
                                                                    <div class="cart-info cart-wrap">
                                                                        <a href="sepet.php?evet=<?php echo $row["id"];?>&normalurun=<?php echo $_GET["id"]; ?>" title="Sepete Ekle"><i class="ti-shopping-cart"></i></a>
                                                                        <a href="sepet.php?evet=<?php echo $row["id"];?>&normalurun=<?php echo $_GET["id"]; ?>" title="Favorilere Ekle"><i class="ti-heart" aria-hidden="true"></i></a>
                                                                    </div>
                                                                </div>
                                                                <div class="product-detail">
                                                                    ...
                                                                    <a href="sepet.php?evet=<?php echo $row["id"];?>&normalurun=<?php echo $_GET["id"]; ?>"><h6><?php echo kisalt($row["baslik"], 47);?></h6></a>
                                                                    <h4 style="text-align: right;padding-right: 30px;"><sup><del><?php echo $row["eskifiyat"]; ?> ₺</del></sup><span class="text-success"> <?php echo "0.00";?> ₺</span></h4>
                                                                </div>
                                                            </div>
                                                        </div>
